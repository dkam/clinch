...
module CspViolationLocalLogger
  ...
  # Only act on our own event; see CspViolationSentrySubscriber.csp_violation?
...
Rails.application.config.after_initialize do
  ...
  Rails.event.subscribe(CspViolationLocalLogger) { |event| CspViolationLocalLogger.csp_violation?(event) }
