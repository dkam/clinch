...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name clinch clinch
...
# file instead, and it is what makes config.release identify a specific build.
ARG GIT_SHA=unknown
